...
<%'*********************************************************************%>
<table id="TABLA" align="center"  bordercolor="#FFFFFF" bgcolor="lightgrey"  cellpadding="2"  cellspacing="1"  border="1" >
<%'**************************%>
...
<%DO WHILE NOT RS.EOF%>
    ...
    <tr  bgcolor="<% if CONT mod 2  = 0 THEN 
        ...
        <%NEXT%>
         ...
         <td style="text-align:right;" CLASS="micro" >
        <%=(FORMATNUMBER(RS.FIELDS.ITEM(I),2,,,TRUE))%>&nbsp;</td>
		  <%FOR I = 5 TO LIMITE %>
		    <td class="micro" style="text-align:left"><%=RS.FIELDS.ITEM(I)%>&nbsp;</td>
        <%NEXT%>
