...
'****************************************************
cad =   " select estcli, descripcion from MODELADOR..estilos    " & _
        " WHERE ESTADO ='A' and cliente = '"&cli&"'             " & _
        " and estcli like '%"&ecl&"%'                           " & _      
...
function redir(fam) {
    ...
    ff = parseInt(fam,10)
    window.opener.thisForm.ECL.value = t.rows(ff).cells(0).innerText;
