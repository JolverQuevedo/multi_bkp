...
<script language="jscript" type="text/jscript">
   // alert(window.parent.window.opener.document.all.compra.value)
    ...
    kag = 'frames/partes_deta_oc_contraMHD.asp?doc=' + trim(window.parent.window.opener.document.all.compra.value)
    window.parent.window.opener.document.all.partes.src = kag

    tap = 'frames/frm_contraocMHD.asp?oc=' + trim(window.parent.window.opener.document.all.compra.value) + '&pro=' + trim(window.parent.window.opener.document.all.rucid.value)
