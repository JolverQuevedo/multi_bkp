...
<iframe  width="100%"  style="display:none" src="" id="actualiza" name="actualiza"  scrolling="yes" frameborder="0" height="100" align="middle"></iframe>
 
<script language="javascript">

    function manda() {
       
            cad = '../comun/asigna_factMHD.asp'
