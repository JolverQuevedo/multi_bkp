...
<tr> 
	<td class="estilo2" align="center" colspan="7">Reportes de Prendas en Proceso anual</td>
</TR>    
<tr><td width="30%"></td>
...
function ENVIO() {
    ...
    cad = 'reportes/prnpren_pro_real.asp?anio=' + trim(thisForm.ano.value) + '&tip=' + tipo
