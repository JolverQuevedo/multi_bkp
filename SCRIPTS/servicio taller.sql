...
select * from po_movi
-- columnas adicionales para INGRESAR LA ORDEN DE SERVICIO
...
SELECT DISTINCT 
                      ...
                      MODELADOR.dbo.POS.CODEST, dbo.PO_MOVI.FECDOC, dbo.PO_MOVI.FECEMB, dbo.PO_MOVI.FACEXP, dbo.PO_MOVI.FACPRO, dbo.PO_MOVI.FECPRO, dbo.PO_MOVI.NUMSER
...
FACPRO, FECPRO, FECEMB, FACEXP, ID, NUMSER,*

FROM view_pos_movi WHERE CODCLI= '00001' 
AND MOV = 'I'
and guia ='001-6' 
