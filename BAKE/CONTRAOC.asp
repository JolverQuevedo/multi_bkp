...
*/
    cad = 'FRAMES/frm_CONTRAOC.asp?oc=' + trim(document.all.oc.value)
...
if (document.all.rep.value=='1')
    ...
    cad += '&fec=' + trim(document.all.fecdoc.value)
...
function asigna() {
    ...
    cad = 'help/hlp_asigna_fact_oc.asp?oc=' + strzero(trim(document.all.compra.value), 10)
