                    ...
                    <table border="0" align="left" cellpadding="0"cellspacing="0" width="100%">
                        ...
                        <tr valign="bottom" height="8px">
                         ...
                         <tr valign="bottom" height="8px"  id="AL" name = "AL">
                            ...
                            <td colspan="1">
                                <!--TODO AGREGAR SELECT ALMACENES-->
                                <select id="alma" name= "alma" class="datosgrande" style="width:100%">
                                    <option value=""></option>
                                    <%
                                    kkk = "Select A1_CALMA, A1_CDESCRI,A1_CDIRECC From RSFACCAR..AL0001ALMA ORDER BY 1"
                                    rs2.open kkk, cnn
                                    ...
                                    <%DO while not rs2.eof%>
                                        <option value="<%=rs2("A1_CALMA")%>"><%=TRIM(rs2("A1_CALMA"))%> - <%=rs2("A1_CDESCRI")%> - <%=rs2("A1_CDIRECC")%></option>
                                        <%rs2.movenext%>
                                    <%loop %>
                                </select>
                                <%RS2.CLOSE %>
                            <!--<input type="text" value="00M2" id="alma" class="inputs" maxlength="4"  />-->
...
cad += '&ser=' + trim('<%=ser%>')
cad += '&Cod=' + aCod
cad += '&alm=' + ltrim(document.all.alma.value)
cad += '&Can=' + aCan
cad += '&des=' + aDes
cad += '&kor=' + aKor
cad += '&ppo=' + aPos
