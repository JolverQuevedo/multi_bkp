...
' ES EL CONTADOR DE LINEAS DE PO MOSTRADAS.,...
 ...
 CAD =	" exec saldoS_po_color_estilo_TEMPORADA  '"&est&"' ,'"&aCol(m)&"', '"&ruc&"',  '"&ser&"', '"&con&"', '"&def&"' , '"&TEM&"' "         
    'RESPONSE.Write(CAD)
    RS.Open CAD, Cnn
...
FOR  MM=0 TO UBOUND(aCol)
    CAD =	" exec saldoS_po_color_estilo_TEMPORADA  '"&est&"' ,'"&aCol(Mm)&"', '"&ruc&"',  '"&ser&"', '"&con&"', '"&def&"', '"&TEM&"' "         
   ' RESPONSE.Write(CAD)
    RS.Open CAD, Cnn
...
'RESPONSE.END
 ...
 <script type='text/javascript'>
     ...
     } window.onmousedown = bloquear; document.onmousedown = bloquear;  </script>   
